...
namespace MyWebsite.Models
{
    public class DataContext : DbContext
    {
        ...
        public void EnsureSeedData()
        {
            ...
            if (!this.Requirements.Any())
            {
                this.Requirements.AddRange(
            ...
            if (!this.ParentRequirements.Any())
            {
                this.ParentRequirements.AddRange(
            ...
            if (!this.ProjectTags.Any())
            {
                this.ProjectTags.AddRange(
