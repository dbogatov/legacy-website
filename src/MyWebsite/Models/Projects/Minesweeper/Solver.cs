...
namespace MyWebsite.Models.Minesweeper
{
	static class SolverLauncher
	{
		...
		{
			int width = httpContext.HttpContext.Session.GetObjectFromJson<Parameters>("Parameters").width;
			int height = httpContext.HttpContext.Session.GetObjectFromJson<Parameters>("Parameters").height;
